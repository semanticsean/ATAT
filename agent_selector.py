...
class AgentSelector:
    ...
    def get_response_for_agent(self,
        ...
        if result['type'] == 'detail':
            ...
            print("=== Processing !summarize shortcode in get_response_for_agent ===")
            print(f"Number of chunks: {len(summarized_responses)}")
            for idx, chunk in enumerate(summarized_responses):
        ...
        print("=== Processing entire content (not chunks) in get_response_for_agent ===")
