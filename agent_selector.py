...
class AgentSelector:
    ...
    def _create_dynamic_prompt(self, agent_manager, agent_name, order, total_order):
    ...
    def get_response_for_agent(self, agent_manager, gpt_model, agent_name, order, total_order, content):
        ...
        self.conversation_structure.setdefault("responses", []).append((agent_name, response))
