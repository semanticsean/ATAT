...
agents_json_path = os.path.join(current_script_directory,
                                '../agents/agents.json')

content_json_path = os.path.join(current_script_directory,
                                 '../static/content.json')

image_static_path = os.path.join(current_script_directory,
                                 '../static/atat.png')
...
def main():
  ...
  # Initialize an empty dictionary if content_json is None
  if content_json is None:
    content_json = {}
  ...
  metadata = {
      ...
      "social_image_url":
      ask_for_input(
          "Enter the social media image URL (or press enter for default): ")
      or "default_social_image_url",
      "logo_url":
      ask_for_input("Enter the logo URL (or press enter for default): ")
      or "default_logo_url"
  }

  # Safely merge dictionaries, ensuring content_json is a dictionary
